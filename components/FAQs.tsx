...
export default function FAQs({accTitle, accContent, id, active, setActive}) {
	...
	return (
		<div className="bg-white relative w-full">
			<div className="w-full mx-auto py-4 px-24 sm:px-8 lg:py-4">
					
					<div className="mt-12 lg:mt-0 ">
							<div>
								<div className="p-2 bg-primary-300 rounded text-xl leading-6 font-bold text-gray-100 flex flex-row justify-between items-center px-3 accTitle">
