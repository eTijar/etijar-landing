...
export function MaxFooter1() {
	return (
		<>
			<div className="relative min-h-auto w-auto pb-3 px-8 bg-primary-50 flex items-start justify-between flex-wrap">
				<div className="mt-2 w-full flex justify-center flex-wrap">
					<div className="md:mb-4 mb-8">
						...
						<div className="flex space-around mt-3">
							<a className="text-xl text-primary-600 rounded-full p-2 bg-blue-300 text-shadow mr-6 hover:bg-white" href="#">
								<FaTwitter />
							</a>
							<a className="text-xl text-primary-600 rounded-full p-2 bg-blue-300 text-shadow mr-6 hover:bg-white" href="#">
								<FaFacebook />
					...
					<div className="mt-6 px-6 mb-16">
						<p className="text-primary-800 text-sm">
							{' '}
							eTijar.com is a property of eTijar Financial Technologies Limited,a company duly registered with the Corporate Affairs Commission of Nigeria. eTijar.com provides financial services in partnership with financial providers. All banking services,savings and account numbers are managed by
				...
				<div className="w-full flex md:justify-between justify-center flex-wrap">
					<div className="flex flex-col justify-around mt-10 w-52">
						...
						<a href="/about" className="mb-2 text-primary-800 hover:text-blue-600">
							About us
						</a>
						<a href="" className="mb-2 text-primary-800 hover:text-blue-600">
							FAQs
						</a>
						<a href="" className="mb-2 text-primary-800 hover:text-blue-600">
							Meet our Team
			...
			<footer className="bg-blue-900 py-4 text-blue-200 text-center">Copyright &copy; eTijar 2021 All Right Served</footer>
		</>
	);
}
			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8 xl:col-span-1">
						...
						<p className="text-gray-500 text-base">Make profit not interest</p>
